...
function FeaturedProjectsProjectPanel({
  ...
  return (
    <article
      ...
      className="relative flex min-h-0 flex-col gap-[var(--spacing-gap-7)] bg-[var(--color-neutral-100-uniform)] pt-[var(--spacing-gap-8)] text-[var(--color-primary-300)] max-[767px]:pb-[var(--spacing-gap-9)] max-[1023px]:min-h-dvh"
    >
      <SectionTitleReveal
        ...
        data-node-id={project.nodeId}
      >
        <p className="text-heading-4 m-0 w-full text-center max-[767px]:!text-[20px] max-[767px]:!leading-[24px] max-[767px]:!tracking-[-0.5px] max-[767px]:whitespace-nowrap">
          Proyectos Destacados
        </p>
        <h2 className="text-heading-1 m-0 w-full text-center max-[767px]:!text-[48px] max-[767px]:!leading-[58px] max-[767px]:!tracking-[-1px]">
          {project.title}
        </h2>
        <p className={`text-heading-6 m-0 w-full ${project.descriptionClassName} text-center opacity-60 max-[767px]:!text-[18px] max-[767px]:!leading-[22px] max-[767px]:!tracking-[-0.5px]`}>
          {project.description}
        </p>
      </SectionTitleReveal>
