...
function FeaturedProjectsMobileCarousel({ columns, galleryLabel }) {
  ...
  return (
    <div
      ...
      className="flex h-full items-start gap-[16px] overflow-x-auto overscroll-x-contain px-[16px] py-[48px] [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden min-[768px]:gap-[16px] min-[768px]:px-[24px] min-[768px]:py-[32px]"
