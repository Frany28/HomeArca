  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="text-heading-4 m-0 w-full max-[767px]:text-[20px] max-[767px]:leading-[24px] max-[767px]:tracking-[-0.5px]" data-node-id="4856:5033">
            Proyectos Destacados
          </p>
          <h2 className="text-heading-1 m-0 w-full max-[767px]:text-[48px] max-[767px]:leading-[58px] max-[767px]:tracking-[-1px]" data-node-id="4856:5034">
            Quinta Bella Vista
          </h2>
          <p className="text-heading-6 m-0 w-full max-w-[520px] opacity-60 max-[767px]:text-[18px] max-[767px]:leading-[22px] max-[767px]:tracking-[-0.5px]" data-node-id="4856:5035">
