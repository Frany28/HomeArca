  ...
  return (
    ...
    >
      <article
        ...
        className="relative flex min-h-0 flex-col bg-[var(--color-neutral-950-uniform)] pt-[var(--spacing-gap-9)] max-[767px]:pb-[var(--spacing-gap-9)] max-[1023px]:min-h-dvh"
      >
        <SectionTitleReveal
        ...
        >
          <p className="text-heading-4 m-0 w-full text-center max-[767px]:!text-[20px] max-[767px]:!leading-[24px] max-[767px]:!tracking-[-0.5px] max-[767px]:whitespace-nowrap" data-node-id="5210:16096">
